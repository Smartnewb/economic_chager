...
export default function FXAnalysisPanel() {
    const {
        showAnalysisPanel,
        closeAnalysisPanel,
        isAnalyzing,
        ...
        <>
            ...
            <div className="fixed right-0 top-0 h-full w-full max-w-2xl bg-gray-900/95 backdrop-blur-lg border-l border-white/10 z-50 overflow-hidden flex flex-col animate-slide-in-right">
                ...
                <div className="flex items-center justify-between p-6 border-b border-white/10">
                    <div>
                        <h2 className="text-xl font-bold text-white">FX Flow Analysis</h2>
                        <p className="text-sm text-gray-400 mt-1">
                            {isAnalyzing
                                ? "Analyzing global capital flows..."
                                : `AI insights on ${selectedPair} and dollar dynamics`}
                        </p>
                    </div>
                    <button
                        onClick={closeAnalysisPanel}
                            ...
                            <div className="flex items-center gap-3 p-4 bg-white/5 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-400">
                                        Analyzing currency flows and market dynamics
                                    </p>
                                </div>
                            </div>
                            {/* Skeleton Loaders */}
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div>
                                        <p className="text-xs text-gray-500">Dollar Index</p>
                                        <p className="text-lg font-bold text-green-400">
                                            {analysisResult.dollarIndex.toFixed(2)}
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-gray-500">Focus Pair</p>
                                    ...
                                    <div>
                                        ...
                                        <p className={`text-lg font-bold ${
                                            ...
                                            {metrics?.riskSentiment === "risk_on" ? "Risk-On" : "Risk-Off"}
                                        </p>
                                    </div>
                                </div>
                            </div>
